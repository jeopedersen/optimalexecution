...
ANNUAL_VOLAT = 0.3                                # Annual volatility in stock price
...
LLAMBDA = 2*10**(-6)                                                       # Trader's risk aversion
LIQUIDATION_TIME = 5                                                # How many days to sell all the shares. 
NUM_N = 5                                                           # Number of trades
EPSILON = BID_ASK_SP / 2 
#SINGLE_STEP_VARIANCE = (np.random.standard_t(1, 5)/100)+1                                                                     # Fixed Cost of Selling.
